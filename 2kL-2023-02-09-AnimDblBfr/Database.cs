...
namespace _2kL_2023_02_09_AnimDblBfr
{
    public class Database
    {
        ...
        public Database(string Host, string user, string password, string database, bool clean_table)
        {
        ...
        {
            using (var cmd = new NpgsqlCommand($"INSERT INTO rectangle_score (rectangle_id, score) VALUES ({id}, 0)", conn))
            {
                cmd.ExecuteNonQuery();
            }
        }
